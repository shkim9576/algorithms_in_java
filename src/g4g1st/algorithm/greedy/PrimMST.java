package g4g1st.algorithm.greedy;
...
public class PrimMST {
    ...
    public static void main(String[] args) {
        ...
        /* Let us create the following g4g1st.graph
           2	3
        (0)--(1)--(2)
         |   / \   |
        6| 8/   \5 |7
    ...
    void primMST(int[][] graph) {
        ...
        for (int i = 0; i < V - 1; i++) {
            ...
            for (int v = 0; v < V; v++) {
                // g4g1st.graph[u][v] is non zero only for adjacent vertices.
                // mstSet[v] is false for vertices not yet included in MST
                // Update the key only if g4g1st.graph[u][v] is smaller than key[v]
